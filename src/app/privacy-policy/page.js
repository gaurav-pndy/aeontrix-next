export const metadata = {
  ...
  openGraph: {
    title: "Privacy Policy | Aeontrix",
    description: "Understand Aeontrix's data protection practices.",
    ...
    <main className="max-w-6xl relative text-lg mx-auto px-4 py-8 pb-20 text-seasalt space-y-10">
      ...
      <section>
        ...
        <div className="md:ml-4">
          ...
          <h3 className="text-xl font-semibold mb-1 mt-4">
            c. System & AI Performance Data (for Clients)
          </h3>
          <ul className="list-disc md:ml-4 list-inside text-[#F8F9FB]/80 space-y-1">
          ...
          <h3 className="text-xl font-semibold mb-1 mt-4">
            d. End-User Data (for Managed/Hosted Services)
          </h3>
          ...
          <p className="text-[#F8F9FB]/80 md:ml-4 leading-relaxed">
            We <b>do not</b> use end-user data for profiling, marketing, or
            resale.
          </p>
        </div>
      </section>
